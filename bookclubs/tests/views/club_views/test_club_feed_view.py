...
class ClubFeedViewTestCase(TestCase):
    ...
    def test_create_club_url(self):
        self.assertEqual(reverse('club_feed', kwargs={'club_name': self.club1.club_name}),
                         f'/club/{self.club1.club_name}/feed/')
        self.assertEqual(reverse('club_feed', kwargs={'club_name': self.club2.club_name}),
                         f'/club/{self.club2.club_name}/feed/')
        self.assertEqual(reverse('club_feed', kwargs={'club_name': self.club3.club_name}),
                         f'/club/{self.club3.club_name}/feed/')
        self.assertEqual(reverse('club_feed', kwargs={'club_name': self.club4.club_name}),
                         f'/club/{self.club4.club_name}/feed/')
    ...
    #         is_active= true
    #         )
    def test_cannot_get_no_exists_club_feed(self):
        self.client.login(username=self.user3.username, password='Password123')
