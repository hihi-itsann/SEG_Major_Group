...
class ClubFeedViewTestCase(TestCase):
    ...
    def test_delete_club_url(self):
        self.assertEqual(reverse('delete_club',kwargs={'club_name':self.club1.club_name}), f'/club/{self.club1.club_name}/delete/')
        self.assertEqual(reverse('delete_club',kwargs={'club_name':self.club2.club_name}), f'/club/{self.club2.club_name}/delete/')
        self.assertEqual(reverse('delete_club',kwargs={'club_name':self.club3.club_name}), f'/club/{self.club3.club_name}/delete/')
        self.assertEqual(reverse('delete_club',kwargs={'club_name':self.club4.club_name}), f'/club/{self.club4.club_name}/delete/')
